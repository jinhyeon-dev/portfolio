...
const Skills = ({ darkMode }) => {
  const skills = [
    { name: 'Flutter', level: 90, color: 'from-cyan-400 to-blue-500' },
    { name: 'React', level: 85, color: 'from-blue-400 to-indigo-500' },
    { name: 'FastAPI', level: 70, color: 'from-green-400 to-emerald-500' },
    { name: 'AWS', level: 65, color: 'from-blue-400 to-cyan-500' }
  ]
